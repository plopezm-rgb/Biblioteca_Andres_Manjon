            ...
            <?php foreach ($usuarios as $usuario): ?>
                <article class="alumno-card" aria-labelledby="usuario-<?php echo $usuario['id_usuario']; ?>">
                    ...
                    <section class="acciones">
                        <a href="editar_alumno.php?id=<?php echo $usuario['id_usuario']; ?>&busqueda=<?php echo urlencode($busqueda); ?>&tipo_busqueda=<?php echo urlencode($tipo_busqueda); ?>" class="btn-editar">Editar</a>
